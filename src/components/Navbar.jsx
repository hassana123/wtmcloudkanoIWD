    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
              ...
              <Link
                ...
                className={`text-md font-semibold transition-colors duration-300 ${
                  location.pathname === link.path
                    ...
                    : 'text-gray-700 hover:text-primary-dark hover:border-b-2 border-transparent'
                } px-3 py-2`}
              >
                {link.name}
              </Link>
          ...
          <button className="btn-primary px-6 py-2 rounded-lg text-lg font-semibold shadow-md hover:shadow-lg transition">Register Now</button>
      ...
      >
        <div className="px-4 pt-4 pb-6 space-y-3">
          ...
          <button className="w-full btn-primary mt-4 py-3 rounded-lg text-lg font-semibold shadow-md hover:shadow-lg transition">Register Now</button>
        </div>
      </motion.div>
    </motion.nav>
  );
